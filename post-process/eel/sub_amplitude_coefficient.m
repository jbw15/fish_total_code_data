...
% rr6(100)=fminsearch(@(c)(sum((yh_amp(100)*sin(2*pi/200*tt2+c)-yh(:,100)').^2)),0.01);

% 
% rr12=rr1;rr12(1:25)=rr1(1:25)+2*pi;rr12(91:99)=rr1(91:99)-2*pi;rr12(100)=2*rr12(99)-rr12(98);%cosider all component set U= 1 *U
% 
% rr22=rr2;rr22(1:13)=rr2(1:13)+2*pi;rr22(73:100)=rr2(73:100)-2*pi;
...
% rr62 = rr6; rr62(1:26) = rr6(1:26)+2*pi;rr62(87:end) = rr6(87:end)-2*pi;
% set(gca,'FontSize',20)
figure
